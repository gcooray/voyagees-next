...
// Covers the existing 7 destinations plus the other common west/south/
// hill-country circuit stops the model tends to include (Colombo, Negombo,
// Polonnaruwa, Anuradhapura, Bentota, Yala/Tissamaharama) — not the
// east/north cluster (Trincomalee, Arugam Bay, Jaffna), which is a
// separate, still-paused effort (see note above).
